...
<body>
  ...
  <main role="main" class="container p-5">
    <h1 class="mt-5 text-center text-info">LOCAUX DE LA M2L</h1><br>
    <p class="lead">
...
<br><br>
    ...
    <img src="images/locaux_1.jpg"  alt="locaux1">
    <br><br>
    <img src="images/locaux_2.jpg"  alt="locaux1">
    <br><br><br>
    <p class="lead">
      Implantation des quatre bâtiments Plan des bâtiment
<br><br>
      Implantation des locaux en rez-de-chaussée des quatre bâtiments Implantation
<br><br>
...
<br><br>
    ...
    <br><br>
    <h5 class="text-danger">Plan standard d'étage : exemple du deuxième étage du bâtiment A</h5><br>
    <img src="images/locaux_3.jpg"  alt="locaux1">
  </main><br><br>

  <footer class="footer">
    <div class="container">
      <div class="footer-copyright text-center">© 2020 By Chaymae Houbbadi - 
